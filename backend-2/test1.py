...
class SHGFormDetector:
    ...
    def crop_and_deskew_table(self, image, bbox, img_name):
        ...
        padding_percent_deskewed = 0.02  # 2% padding (increased from 1%)
        padding_w_deskewed = max(50, int(w_deskewed_orig * padding_percent_deskewed))  # Min 50px
        padding_h_deskewed = max(50, int(h_deskewed_orig * padding_percent_deskewed))  # Min 50px
